...
Tamponi {data-navmenu='Nazionale'}
===================================== 
...
Casi e positivi {data-navmenu='Nazionale'}
===================================== 
...
```{r echo=FALSE, fig.cap="I nuovi casi sono quelli osservati in un giorno, mentre la variazione positivi, mentre la variazione dei positivi è la variazione dei positivi dovuta ad entrate ed uscite."}
axis_x <- list(showgrid = T, zeroline = F, nticks = 20, showline = T, title = '', mirror = 'all', tickangle = 45, titlefont = f1)
...
Positivi e nuovi casi {data-navmenu='Regionale'}
=====================================
...
Casi {data-navmenu='Internazionale' }
=====================================
